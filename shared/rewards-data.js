...
const REWARD_TIERS = {
  ...
  t5: [ // 10/10, one-off. Each line already opens with its own score/exclamation, so no dynamic prefix is added for this tier.
    {emoji:"🇺🇦", uk:"Прапор твій, вареники подано, громадянство майже офіційне.", en:"Flag's yours, вареники are served, citizenship is basically official."},
    ...
    {emoji:"🏆", uk:"Ти явно знаєш, про що йдеться.", en:"You clearly know your stuff."},
    ...
    {emoji:"🍰", uk:"Медовик у дев'ять коржів, і кожен вдався.", en:"Медовик with nine layers, and every single one came out right."},
    ...
    {emoji:"🍯🍶", uk:"Малинова медовуха, найкраща партія в льоху, тільки для тебе.", en:"Raspberry медовуха, the best batch in the cellar, just for you."},
    ...
    {emoji:"🏆", uk:"Сало нарізали найтоншими скибками, спеціально для переможця.", en:"Сало cut into the thinnest slices, just for the winner."},
    ...
    {emoji:"🏛️", uk:"Бездоганно. Терміново повідомте сільраду.", en:"Flawless. Somebody alert the village council."},
